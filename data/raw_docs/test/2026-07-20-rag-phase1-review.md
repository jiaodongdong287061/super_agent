...
| 模块 | 状态 | 说明 |
|------|------|------|
| 9 种文档加载器 | ✅ | PDF/Word/MD/HTML/TXT/JSON/CSV/Excel/PPT，工厂注册模式；PDF 按5页分组合并保留跨页上下文 |
| 语义切分器 | ✅ | 标题链继承、句子级 overlap、Embedding 语义边界检测、5页合并分组 + char_start 偏移追踪实现跨页页码归属 |
...
| 增量索引 | ✅ | MD5 哈希追踪，每文件粒度，char_start → page_numbers 映射，并发 embedding 8路 |
